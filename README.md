...
└── sales/
    ...
    ├── ui/
    │	├── customer/
    │   │	├── CustomerCredits.java
    │   │	├── CustomerBillingAddress.java
    │   │	├── CustomerDeliveryAddress.java
    │   │	├── CustomerAddress.java
    │   │	├── CustomerGeneral.java
    │   │	├── CustomerWithAddress.java
    │   │	├── CustomerAdditionalInfo.java
    │   │	├── CustomersMenu.java
    │   │	├── NewCustomer.java
    ...
    │   │    	│   ├── DailySummary.java
    │   │    	│   ├── MonthlySummary.java
    │   │    	│   ├── ByPeriodSummary.java
    │   │    	│   └── SalesSummaryMenu.java
    │   │    	│
    │   │    	└── sales_by_product/
    │   │        	├── AnnualByProduct.java
    │   │        	├── DailyByProduct.java
    │   │        	├── MonthlyByProduct.java
    │   │        	├── ByPeriodByProduct.java
    │   │        	└── SalesByProductMenu.java
    │	│
    │	├── BaseMenu.java
    │	└── MainMenu.java
    │
